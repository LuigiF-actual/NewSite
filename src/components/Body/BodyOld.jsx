...
const Home = () => {
  ...
  return (
    ...
    <div className="z-10 grid grid-cols-6 grid-rows-[auto_auto_auto_auto] gap-2 min-w-screen border-2 border-amber-50 ">
      <Title />
      <Description />
      <Technologies />
      <ContactMe />
...
const PhotoHolder = () => {
  ...
  return (
    <div className="z-10 col-start-4 col-span-2 row-start-2 row-span-2 BoxOfText relative">
      <div className="flex justify-center relative">
        <img src={Myphoto} alt="Girl in a jacket" className="h-80 w-55" />
      </div>
    </div>
  )
}
